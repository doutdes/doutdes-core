...
const getInstagramData = async (pageID, metric, period=null, since=null, until=null, token, mediaID=null) => {
...
module.exports = {getInstagramData, getPagesID, getMedia, getStories, revokePermission, METRICS, PERIOD, INTERVAL};