...
const yt_getData = async (refreshToken, metric, channel_id, start_date, end_date) => {
    const {endPoint, params} = getParams(metric, channel_id, start_date, end_date);
...
const getParams = (metric, channelId, start_date, end_date) => {
