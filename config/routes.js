...
module.exports = function (app, passport) {
    ...
    app.get(igPath + ':page_id/audcity', requireAuth, AccessManager.roleAuthorization(all), IgManager.setMetric(IGM.AUDIENCE_CITY,IGPeriod.LIFETIME,0), IgManager.ig_getData);
    app.get(igPath + ':page_id/audcountry', requireAuth, AccessManager.roleAuthorization(all), IgManager.setMetric(IGM.AUDIENCE_COUNTRY,IGPeriod.LIFETIME,0), IgManager.ig_getData);
    app.get(igPath + ':page_id/audgenderage', requireAuth, AccessManager.roleAuthorization(all),  IgManager.setMetric(IGM.AUDIENCE_GENDER_AGE,IGPeriod.LIFETIME,0), IgManager.ig_getData);
    app.get(igPath + ':page_id/audlocale', requireAuth, AccessManager.roleAuthorization(all), IgManager.setMetric(IGM.AUDIENCE_LOCALE,IGPeriod.LIFETIME,0), IgManager.ig_getData);
    app.get(igPath + ':page_id/emailcontacts', requireAuth, AccessManager.roleAuthorization(all), IgManager.setMetric(IGM.EMAIL_CONTACTS,IGPeriod.DAY,29), IgManager.ig_getData);
    app.get(igPath + ':page_id/followercount', requireAuth, AccessManager.roleAuthorization(all), IgManager.setMetric(IGM.FOLLOWER_COUNT,IGPeriod.DAY,29),  IgManager.ig_getData);
    app.get(igPath + ':page_id/getdirclicks', requireAuth, AccessManager.roleAuthorization(all), IgManager.setMetric(IGM.GET_DIRECTIONS_CLICKS,IGPeriod.DAY,29), IgManager.ig_getData);
    app.get(igPath + ':page_id/impressions', requireAuth, AccessManager.roleAuthorization(all), IgManager.setMetric(IGM.IMPRESSIONS,IGPeriod.D_28,29), IgManager.ig_getData);
    app.get(igPath + ':page_id/onlinefollowers', requireAuth, AccessManager.roleAuthorization(all), IgManager.setMetric(IGM.ONLINE_FOLLOWERS,IGPeriod.LIFETIME,0), IgManager.ig_getData);
    app.get(igPath + ':page_id/phonecallclicks', requireAuth, AccessManager.roleAuthorization(all), IgManager.setMetric(IGM.PHONE_CALL_CLICKS,IGPeriod.DAY,29), IgManager.ig_getData);
    app.get(igPath + ':page_id/profileviews', requireAuth, AccessManager.roleAuthorization(all), IgManager.setMetric(IGM.PROFILE_VIEWS,IGPeriod.DAY,29), IgManager.ig_getData);
    app.get(igPath + ':page_id/reach', requireAuth, AccessManager.roleAuthorization(all), IgManager.setMetric(IGM.REACH,IGPeriod.D_28,29), IgManager.ig_getData);
    app.get(igPath + ':page_id/textmessageclicks', requireAuth, AccessManager.roleAuthorization(all), IgManager.setMetric(IGM.TEXT_MESSAGE_CLICKS,IGPeriod.DAY,29), IgManager.ig_getData);
    app.get(igPath + ':page_id/websiteclicks', requireAuth, AccessManager.roleAuthorization(all), IgManager.setMetric(IGM.WEBSITE_CLICKS,IGPeriod.DAY,29), IgManager.ig_getData);
