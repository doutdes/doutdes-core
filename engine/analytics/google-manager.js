...
exports.ga_getBrowsers = async function (req, res, next) {
    GaToken.findOne({
        ...
        GoogleApi.getBrowsers(key.client_email, key.private_key, req.params.start_date, req.params.end_date)
            .then(value => {
                if (value.length === 0) {
                    return res.status(HttpStatus.NO_CONTENT).send({});
                } else
...
exports.ga_getBounceRate = async function (req, res, next) {
    GaToken.findOne({
        ...
        GoogleApi.getBounceRate(key.client_email, key.private_key, req.params.start_date, req.params.end_date)
            .then(value => {
                if (value.length === 0) {
                    return res.status(HttpStatus.NO_CONTENT).send({});
                } else
...
exports.ga_getAvgSessionDuration = async function (req, res, next) {
    GaToken.findOne({
        ...
        GoogleApi.getAvgSessionDuration(key.client_email, key.private_key, req.params.start_date, req.params.end_date)
            .then(value => {
                if (value.length === 0) {
                    return res.status(HttpStatus.NO_CONTENT).send({});
                } else
...
exports.ga_getPageviewsPerSession = async function (req, res, next) {
    GaToken.findOne({
        where: {
            user_id: req.user.id
        }
    }).then(key => {
        GoogleApi.getPageviewsPerSession(key.client_email, key.private_key, req.params.start_date, req.params.end_date)
            .then(value => {
                if (value.length === 0) {
                    return res.status(HttpStatus.NO_CONTENT).send({});
                } else
...
exports.ga_getNewUsers = async function (req, res, next) {
    GaToken.findOne({
        ...
        GoogleApi.getNewUsers(key.client_email, key.private_key, req.params.start_date, req.params.end_date)
            .then(value => {
                if (value.length === 0) {
                    return res.status(HttpStatus.NO_CONTENT).send({});
                } else
